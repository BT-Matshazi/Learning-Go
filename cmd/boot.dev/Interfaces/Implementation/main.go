...
// Assignment
// At Textio we have full-time employees and contract employees. We have been tasked with making a 
// more general employee interface so that dealing with different employee types is simpler.
